            ...
            <div className="comment-wrap mt-10">
                {
                    ...
                    <>
                        {_.chunk(commentList, 3)[currentCommentPage - 1].map((comment, index) => (
                        ...
                        <Pagination
                            ...
                            pageSize={3}
                            onClick={(page: string) => setCurrentCommnetPage(Number(page))}
                        />
                    </>
                }
                ...
                <div className='comment-write' style={{ padding: "0 30px" }}>
                    ...
                    <div style={{ padding: "10px 0 10px", textAlign: "right", marginRight: "" }}>
                        <button onClick={() => {
